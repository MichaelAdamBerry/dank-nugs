import One from "../../code-snippets/styled-components/One";
import Two from "../../code-snippets/styled-components/Two";
import Three from "../../code-snippets/styled-components/Three";
import Four from "../../code-snippets/styled-components/Four";
import Parent from "../../code-snippets/styled-components/Parent";
import StyledButton from "../../code-snippets/styled-components/StyledButton";
import Def from "../../code-snippets/styled-components/Def";

import StyleBlock from "../../code-snippets/styled-components/StyleBlock";
import BlogMeta from "../../components/BlogMeta";

export const meta = {
  title: "Styled Components",
  // The tags are used for SEO in the header property: `<meta name="keywords" content={stringOfAllPostTags} />`
  tags: ["css", "css-in-js", "javascript", "react", "design-systems"],
  layout: "post",
  publishDate: "2019-10-9",
  modifiedDate: false, // "If used it must be in 'YYYY-MM-DD format' like publishDate"
  seoDescription: "CSS in Javascript with Styled Components.",
  exclude: false,
  kicker:
...
<One figCaption={"A Component with State"} />
...
<Two figCaption={"A State-less Component that Recieves Props"} />
...
<Three figCaption={"A Component that Renders a  Styled Component"} />
<StyledButton />
...
<Four figCaption={"A Component with Styled JSX / Default in Next.js"} />
